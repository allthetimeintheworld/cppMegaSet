...
/*   Updated: 2025/06/18 15:59:23 by jadyar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	//so the contrete derived classes still work but i broke Animal, my favourite muppet
	...
	for (int i = 0; i < arraySize; i++)
	{
		...
		delete petShop[i]; // double check if i can delete[] petshop
	}
	...
	fido->getBrain()->setIdea(0, "I want to chase my tail.");
	fido->getBrain()->setIdea(1, "I love my tail.");
